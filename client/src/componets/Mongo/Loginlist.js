...
const Loginlist = () => {
    ...
    const getUseApi = () => {
        ...
        axios.get('http://localhost:8080/api/mongodb/user').then((response) => {
            console.log("----------------->", response.data.result)
            setUserlist1(response.data.result)
            setMsg("Successs")
        }).catch((error) => {
            setMsg("Unsuccess")
        });
    ...
    const Deleteitem = (item) => {
        ...
        axios.delete(`http://localhost:8080/api/mongodb/user/${item._id}`, config).then((response) => {
            getUseApi()
            console.log("success");
